         ...
         <a href="/susers/build/php/app/staff/services-tab.php" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-green-800 group">
           ...
           <li>
            ...
            <ul id="request-dropdown" class="py-2 space-y-2">
                  ...
                  <li>
                     <a href="/susers/build/php/app/staff/requesttab/req-disapproved.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group bg-green-800">Disapproved</a>
                  </li>
            </ul>
         </li>
         <li>
