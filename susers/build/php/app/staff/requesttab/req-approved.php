         ...
         <a href="/susers/build/php/app/staff/services-tab.php" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-green-800 group">
           ...
           <li>
            ...
            <ul id="request-dropdown" class="py-2 space-y-2">
                  ...
                  <li>
                     <a href="/susers/build/php/app/staff/requesttab/req-approved.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group bg-green-800">Approved</a>
                  </li>
                  <li>
      ...
      <div class="shadow-md h-full overflow-y-auto sm:rounded-md bg-white">
         <table class="table-fixed w-full">
            ...
            <tbody>
               ...
               <?php endforeach; ?>
                   <?php else : ?>
                       <td class="p-5 text-lg font-medium text-green-600" colspan="7">No Approved Request.</td>
                   <?php endif; ?>
               </tr>    
            </tbody>
          </table>
...
<div id="overview-modal" class="fixed inset-0 bg-gray-800 bg-opacity-60 flex items-center justify-center">
     ...
     <div class="flex h-14 border-t border-gray-200 rounded-b justify-end items-center">
            <button id="revoke_btn" class="bg-red-600 hover:bg-red-700 mr-4 px-3 py-2 rounded-md text-white h-fit hidden">Revoke</button>
      </div>
  </div>
