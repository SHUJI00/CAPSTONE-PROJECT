         ...
         <table class="table-fixed w-full">
            <thead class="sticky top-0 bg-[#47BC8D]">
              <tr>
                  ...
                  <th class="w-1/3 text-left text-white p-1.5 font-medium">Date Approved</th>
                  <th class="w-10"></th>
              </tr>
            </thead>
            <tbody>
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex flex-row gap-2">
               ...
               <div class="p-4 md:p-5 space-y-2 w-1/2 overflow-y-auto">
                  ...
                  <p class="text-base leading-relaxed text-gray-500">
                     <b>Assigned Personnel</b> Jese Leos
                  </p>
                  <p class="text-base leading-relaxed text-gray-500">
                     <b>Priority Level:</b> Dec 10, 2002
                  </p>
                  <p class="text-base leading-relaxed text-gray-500">
                     <b>Work Complexity:</b> Simple (20 Days)
                  </p>
                  <p class="text-base leading-relaxed text-gray-500">
