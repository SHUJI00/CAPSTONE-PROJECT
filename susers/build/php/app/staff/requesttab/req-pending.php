    ...
    function filterTable() {
        ...
        tableRows.forEach(row => {
            ...
            if (searchBy === 'requested-by') {
                textContent = row.querySelector('td:nth-child(4)').textContent.trim().toLowerCase();
...
<div id="overview-modal" class="fixed inset-0 bg-gray-800 bg-opacity-60 flex items-center justify-center">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg w-3/4">
            <!-- Modal header -->
            ...
            <div class="flex flex-row gap-2 h-96">
               <div class="p-4 md:p-5 space-y-2 w-full overflow-y-auto bg-gray-100">
...
?>
<div class="p-4 md:p-5 space-y-4 w-1/2 overflow-y-auto hidden">
    <div class="w-full h-40">
        ...
        <div class="flex items-center gap-2 p-4 md:p-5 border-t border-gray-200 rounded-b justify-end">
               <button id="approved_btn" type="button" class="bg-green-700 hover:bg-green-600 py-2 px-2 rounded-md text-white font-medium hidden">Approved</button>
               <button id="disapproved_btn" type="button" class="bg-red-700 hover:bg-red-600 py-2 px-2 rounded-md text-white font-medium hidden">Disapproved</button>
         </div>
</div>
