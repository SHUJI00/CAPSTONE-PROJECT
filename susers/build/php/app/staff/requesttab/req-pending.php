  ...
  <a href="/susers/build/php/app/admin/index.php" class="flex md:me-24 mb-5 justify-center w-full">
     ...
     <div class="h-full px-3 pb-4 overflow-y-auto bg-green-700">
        <ul class="space-y-2 font-medium">
           <li>
              <a href="/susers/build/php/app/staff/index.php" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-green-800 group">
                 <img class="h-8" src="/susers/asset/icons/dashboard.png" alt="dashicon" disable>
                 <span class="ms-3 text-white">Dashboard</span>
              </a>
           </li>
           <li>
            <a href="/susers/build/php/app/staff/services-tab.php" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-green-800 group">
               <img class="h-8" src="/susers/asset/icons/services.png" alt="serviceicon">               
               <span class="ms-3 text-white">Service</span>
            </a>
         </li>
           <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-600 transition duration-75 rounded-lg group bg-green-800" aria-controls="request-dropdown" data-collapse-toggle="request-dropdown">
            ...
            <ul id="request-dropdown" class="py-2 space-y-2">
                  <li>
                     <a href="/susers/build/php/app/staff/requesttab/req-pending.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group bg-green-800">Pending</a>
                  </li>
                  <li>
                     <a href="/susers/build/php/app/staff/requesttab/req-approved.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-green-800">Approved</a>
                  </li>
                  <li>
                     <a href="/susers/build/php/app/staff/requesttab/req-disapproved.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-green-800">Disapproved</a>
                  </li>
            </ul>
         </li>
         <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-600 transition duration-75 rounded-lg group hover:bg-green-800" aria-controls="assigned-work" data-collapse-toggle="assigned-work">
            ...
            <ul id="assigned-work" class="hidden py-2 space-y-2">
               <li>
                  <a href="/susers/build/php/app/staff/assignedworktab/assignwork-ongoing.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-green-800">Ongoing</a>
               </li>
               <li>
                  <a href="/susers/build/php/app/staff/assignedworktab/assignwork-complete.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-green-800">Complete</a>
               </li>
               <li>
                  <a href="/susers/build/php/app/staff/assignedworktab/assignwork-pending.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-green-800">Pending</a>
               </li>
               <li>
                  <a href="/susers/build/php/app/staff/assignedworktab/assignwork-close.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-green-800">Close</a>
               </li>
            </ul>
         </li>
        </ul>
...
<div class="relative w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex flex-row gap-2">
               ...
               <div class="p-4 md:p-5 space-y-2 w-1/2 overflow-y-auto">
                  <p class="text-base leading-relaxed text-gray-500">
                     The request shall be held pedding due to:
                  </p>
                  <p class="text-base leading-relaxed text-gray-500">
                     <b>Target Start Date:</b>
                     Dec 30, 2002
                  </p>
                  <p class="text-base leading-relaxed text-gray-500">
                     <b>Target Start End:</b>
                     Dec 30, 2002
                  </p>
                  <p class="text-base leading-relaxed text-gray-500">
                     <b>Non-availability of materials</b>
                  </p>

               <div class="h-36 w-fit overflow-y-auto">
                 <table>
                     <thead class="bg-green-500 sticky top-0">
                        <tr>
                           <th class="w-20 pl-1 text-left text-white">No.</th>
                           <th class="w-20 pl-1 text-left text-white">Quantity</th>
                           <th class="w-20 pl-1 text-left text-white">Unit</th>
                           <th class="w-60 pl-1 text-left text-white">Description</th>
                           <th class="w-20 pl-1 text-left text-white">Delete</th>
                        </tr>
                     </thead>
                     <tbody>
                        <tr class="border-b-2">
                            <td class="pl-1 text-gray-700">1</td>
                            <td class="pl-1 text-gray-700">1</td>
                            <td class="pl-1 text-gray-700">1</td>
                            <td class="pl-1 text-gray-700">lorem insum lrem enson</td>
                            <td class="pl-1"><a class="text-red-600 hover:underline" href="">Delete</a></td>
                        </tr>
                        <tr class="border-b-2">
                            <td class="pl-1 text-gray-700">1</td>
                            <td class="pl-1 text-gray-700">1</td>
                  ...
                  <p class="text-base leading-relaxed text-gray-500">
                     <b>Non-availability of skilled personnel</b>
                  </p>
                  <div class="h-36 w-fit overflow-y-auto">
                 <table>
                     <thead class="bg-green-500 sticky top-0">
