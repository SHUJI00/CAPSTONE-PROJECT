    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-5">
      <div class="flex items-center justify-between">
        ...
        <div class="absolute ml-10 md:ml-64 font-bold text-xl md:text-3xl text-gray-600">
         <h1 class="uppercase">Pending Work</h1>
        </div>
        <!--Profile start-->
  ...
  <a href="/susers/build/php/app/staff/index.php" class="flex md:me-24 mb-5 justify-center w-full">
     ...
     <div class="h-full px-3 pb-4 overflow-y-auto bg-green-700">
        <ul class="space-y-2 font-medium">
           <li>
              <a href="/susers/build/php/app/staff/index.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-800 group">
           ...
           <li>
            ...
            <ul id="request-dropdown" class="hidden py-2 space-y-2">
                  <li>
                     <a href="/susers/build/php/app/staff/requesttab/req-pending.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-green-800">Pending</a>
                  </li>
                  <li>
         ...
         <li>
            ...
            <ul id="assigned-work" class="py-2 space-y-2">
               ...
               <li>
                  <a href="/susers/build/php/app/staff/assignedworktab/assignwork-pending.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group bg-green-800">Pending</a>
               </li>
               <li>
         ...
         <table class="table-fixed w-full">
            <thead class="sticky top-0 bg-[#47BC8D]">
              <tr>
                  ...
                  <th class="w-1/3 text-left text-white p-1.5 font-medium">Assigned Personnel</th>
                  <th class="w-1/3 text-left text-white p-1.5 font-medium">Target Start</th>
                  <th class="w-1/3 text-left text-white p-1.5 font-medium">Target End</th>
                  <th class="w-10"></th>
                  <th class="w-10"></th>
              </tr>
            </thead>
