    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-5">
      <div class="flex items-center justify-between">
        ...
        <div class="absolute ml-10 md:ml-64 font-bold text-xl md:text-3xl text-gray-600">
         <h1 class="uppercase">Ongoing Work</h1>
        </div>
        <!--Profile start-->
        ...
        <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="assigned-work" class="py-2 space-y-2">
               <li>
                  <a href="/susers/build/php/app/staff/assignedworktab/assignwork-ongoing.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group bg-green-800">Ongoing</a>
               </li>
               <li>
