    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-5">
      <div class="flex items-center justify-between">
        ...
        <div class="absolute ml-10 md:ml-64 font-bold text-xl md:text-3xl text-gray-600">
         <h1 class="uppercase">completed work</h1>
        </div>
        <!--Profile start-->
        ...
        <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="assigned-work" class="py-2 space-y-2">
               ...
               <li>
                  <a href="/susers/build/php/app/staff/assignedworktab/assignwork-complete.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group bg-green-800">Complete</a>
               </li>
               <li>
         ...
         <table class="table-fixed w-full">
            <thead class="sticky top-0 bg-[#47BC8D]">
              <tr>
                  ...
                  <th class="w-1/3 text-left text-white p-1.5 font-medium">Date Completed</th>
                  <th class="w-10"></th>
                  <th class="w-10"></th>
              </tr>
            </thead>
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex flex-row gap-2">
               ...
               <div class="p-4 md:p-5 space-y-2 w-1/2 overflow-y-auto">
                  ...
                  <p class="text-base leading-relaxed text-gray-500">
                     The request shall be worked on immediately.
                  </p>
                  <p class="text-base leading-relaxed text-gray-500">
                  ...
                  <div>
                  <a href="" class="hover:underline flex flex-row gap-1 py-1 px-2 rounded-md text-green-600 font-medium uppercase">View Uploaded Images</a>
