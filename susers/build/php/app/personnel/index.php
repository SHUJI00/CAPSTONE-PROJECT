   ...
   <div class="flex flex-col gap-2 items-center text-center justify-center">
     ...
     <div class="h-full px-3 pb-4 overflow-y-auto bg-green-700">
        <ul class="space-y-2 font-medium">
           <li>
              <a href="/susers/build/php/app/personnel/index.php" class="flex items-center p-2 text-gray-900 rounded-lg bg-green-800 group">
         ...
         <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
            ...
            <div class="flex flex-col gap-1 shadow-md py-3 px-4 bg-white">
               <div class="flex items-center gap-1">
                  <img class="h-8" src="/susers/asset/icons/assignedwp.png" alt="overallicon">
                  <h1 class="text-sm xl:text-base font-medium mb-1 text-gray-700">Assigned</h1>
               </div>
            ...
            <div class="flex flex-col gap-1 shadow-md py-3 px-4 bg-white">
               <div class="flex items-center gap-1">
                  ...
                  <p class="text-white max-w pl-2 py-1 bg-[#80332E]">0</p>
            </div>
         </div>   
      </div>
