...
<head>
    ...
    <title>Personnel/Complete</title>
     ...
     <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="assigned-work" class="py-2 space-y-2">
                  ...
                  <li>
                     <a href="/susers/build/php/app/personnel/assignedworktab/assignwork-complete.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group bg-green-800">Complete</a>
                  </li>
                  <li>
