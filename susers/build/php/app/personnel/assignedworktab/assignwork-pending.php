     ...
     <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="assigned-work" class="py-2 space-y-2">
                  ...
                  <li>
                     <a href="/susers/build/php/app/personnel/assignedworktab/assignwork-ongoing.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hoverbg-green-800">Ongoing</a>
                  </li>
                  <li>
                     <a href="/susers/build/php/app/personnel/assignedworktab/assignwork-pending.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group bg-green-800">Pending</a>
                  </li>
                  <li>
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex flex-row gap-2">
               ...
               <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b justify-end">
                   <button data-modal-hide="default-modal" type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Start Work</button>
               </div>
