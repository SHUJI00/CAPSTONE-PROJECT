document.addEventListener('DOMContentLoaded', (event) => {
    ...
    const datedisapproved = document.getElementById('modal-datedisapproved');
    ...
    overviewButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            const details = {
                ...
                date_disapproved: button.getAttribute('req-assesment-date-disapproved'),
            ...
            datedisapproved.textContent = details.date_disapproved;
