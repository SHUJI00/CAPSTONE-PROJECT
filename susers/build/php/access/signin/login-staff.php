...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT s.*, l.username, l.password, l.loginacc_status, l.user_type
    FROM staff_acc s
...
<div class="flex flex-row justify-between items-center">
    ...
    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="w-fit text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-left inline-flex items-center uppercase" type="button">Staff<svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
