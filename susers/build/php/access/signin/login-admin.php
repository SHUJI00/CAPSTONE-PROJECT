...
<body class="bg-[#F9FAFB] font-sans flex flex-col sm:flex-row items-center h-screen md:justify-evenly">

<img class="md:h-1/4 h-40" src="/susers/asset/img/workflowpro.png" alt="_logo">
<form class="md:w-auto w-2/3 px-8 py-7 rounded-md shadow-md bg-[#ffff] flex flex-col gap-4" action="">
...
<div class="flex flex-row justify-between items-center">
    ...
    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="w-fit text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-left inline-flex items-center uppercase" type="button">Admin<svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        ...
        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
              ...
              <li>
                <a href="/susers/build/php/access/signin/login-personnel.php" class="block px-4 py-2 hover:bg-gray-100 uppercase">Personnels</a>
              </li>
            </ul>
        </div>
</div>
    ...
    <div class="flex flex-col md:w-80 ">
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" name="floating_password" id="floating_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-green-500 peer" placeholder=" " required />
            <label for="floating_password" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Username</label>
        </div>
        <div class="relative z-0 w-full mb-5 group">
            ...
            <label for="floating_password" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Password</label>
        </div>
    </div>
    <!--Submit Button-->
    <button type="submit" onclick="javascript:window.location.href='/susers/build/php/app/admin/index.php';" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-2xl px-5 py-2.5 me-2 mb-2 uppercase">Login</button>
    </form>
</body>
